    ...
    <LayoutGame>
      ...
      <div className="flex items-center justify-center flex-col relative space-y-6 font-mono">
        <div className="font-bold  text-2xl text-center px-5">
          <h1>
          Fill in the missing syntax to create a heading for "Journey to the Stars" using the appropriate &lt;h1&gt; tag.
        ...
        <div className="bg-[#222] text-white font-mono p-4 rounded-md mt-3 overflow-auto max-w-[700px] w-[350px] mx-auto text-sm">
 
  
<pre className="whitespace-pre-wrap leading-tight">
  {`<html>
  <body>
    <h____>Journey to the Stars</h1>
  </body>
</html>`}
</pre>
</div>
