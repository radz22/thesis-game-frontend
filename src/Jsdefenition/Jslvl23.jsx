        ...
        <Jslayout>
          <div className="w-full h-full flex flex-col  font-mono">
            ...
            <div className="mt-20 text-center space-y-6">
              <h1 className="font-bold text-4xl">Level 23: DOM Manipulation (Changing Content)
</h1>
            </div>
            ...
            <div className="w-full text-center mt-5 px-10">
              ...
              You can change words on a website, like updating your Moon mission.
            ...
            <div className="w-full flex justify-center items-center mt-10">
              <div className="bg-[#222] rounded-md text-white text-[10px]   ">
                <pre className="whitespace-pre-wrap leading-relaxed px-9 py-1">
                  <p>Example:</p>
                  <code>
  {"document.getElementById(\"message\").innerHTML = \"Moon fun time!\";"}
</code>
                </pre>
              </div>
            </div>
